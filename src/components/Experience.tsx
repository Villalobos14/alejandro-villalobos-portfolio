...
export default function Experience() {
  return (
    <section className='h-full p-8 pt-12  md:p-20 font-light text-white'>
      <h2 className='font-medium text-4xl'>
        Experience
      </h2>
      <article className='flex flex-col mt-10'>
        <h3 className="flex flex-col items-start text-3xl text-secondary">
          <span className="text-gray-500 text-lg text-white">01</span>
      ...
      <article className='flex flex-col mt-10'>
        <h3 className="flex flex-col items-start text-3xl text-secondary">
          <span className="text-gray-500 text-lg text-white">02</span>
