...
function Hero() {
  return (
    <main
      className="h-screen flex flex-col px-8 xl:px-16 pt-10 text-white"
      id="home"
    >
      {/* Hero Text Block */}
      <div className="flex flex-col  max-w-5xl items-start">
        <p className="text-4xl xl:text-7xl font-medium leading-tight">
          ...
          <span className="text-secondary"> research driven solutions </span>
          for
          <span className="text-secondary"> HSBC</span>.
        </p>
        {/* Skill Badges */}
